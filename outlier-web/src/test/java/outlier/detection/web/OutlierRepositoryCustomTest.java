...
import outlier.detection.web.Application;
import outlier.detection.web.OutlierRepository;
import outlier.detection.web.OutlierRepositoryCustom;
...
public class OutlierRepositoryCustomTest {
	...
	public void shouldReturnPublishers() {
		...
		List<String> actual = outlierRepositoryCustom
				.findDistinctPublishers();
